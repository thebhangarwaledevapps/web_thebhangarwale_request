...
class GoogleMediaUploadDataSourceImplTest {
    ...
    public void test_Google_Photo_Client() throws IOException, ExecutionException, InterruptedException {
        ...
        List<MediaItem> list = googleImageUploadDataSource.uploadMedia(Arrays.asList(multipartFile1,multipartFile2,multipartFile3));
    ...
    public void test_to_find_proper_image_url_from_google_photos(){
        List<MediaItem> mediaItems = googleImageUploadDataSource.getCustomerMediaByMediaId(Arrays.asList("AOqewoK4O4gKXZJ8qNK5AirPfZ2J448" +
                "6BjlXliBCt4Y1CsGEvxDUPy5xInC7F_FyoregUIEA1D4Eso23LSSg8eR6Rw1BxDPBlA"));
